...
\f\r"'\`<>=]|("|')|))|$)`,"g"),Yt=/'/g,Jt=/"/g,de=/^(?:script|style|textarea|title)$/i,pe=e=>(t,...s)=>({_$litType$:e,strings:t,values:s}),o=pe(1),Zt=pe(2),G=Symbol.for("lit-noChange"),p=Symbol.for("lit-nothing"),Xt=new WeakMap,W=H.createTreeWalker(H,129);function he(e,t){if(!Dt(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return Kt!==void 0?Kt.createHTML(t):t}const Re=(e,t)=>{const s=e.length-1,a=[];let n,i=t===2?"<svg>":t===3?"<math>":"",r=X;for(let l=0;l<s;l++){const c=e[l];let d,m,u=-1,f=0;for(;f<c.length&&(r.lastIndex=f,m=r.exec(c),m!==null);)f=r.lastIndex,r===X?m[1]==="!--"?r=qt:m[1]!==void 0?r=Gt:m[2]!==void 0?(de.test(m[2])&&(n=RegExp("</"+m[2],"g")),r=U):m[3]!==void 0&&(r=U):r===U?m[0]===">"?(r=n??X,u=-1):m[1]===void 0?u=-2:(u=r.lastIndex-m[2].length,d=m[1],r=m[3]===void 0?U:m[3]==='"'?Jt:Yt):r===Jt||r===Yt?r=U:r===qt||r===Gt?r=X:(r=U,n=void 0);const _=r===U&&e[l+1].startsWith("/>")?" ":"";i+=r===X?c+Ne:u>=0?(a.push(d),c.slice(0,u)+le+c.slice(u)+z+_):c+z+(u===-2?l:_)}return[he(e,i+(e[s]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),a]};class at{constructor({strings:t,_$litType$:s},a){let n;this.parts=[];let i=0,r=0;const l=t.length-1,c=this.parts,[d,m]=Re(t,s);if(this.el=at.createElement(d,a),W.currentNode=this.el.content,s===2||s===3){const u=this.el.content.firstChild;u.replaceWith(...u.childNodes)}for(;(n=W.nextNode())!==null&&c.length<l;){if(n.nodeType===1){if(n.hasAttributes())for(const u of n.getAttributeNames())if(u.endsWith(le)){const f=m[r++],_=n.getAttribute(u).split(z),S=/([.?@])?(.*)/.exec(f);c.push({type:1,index:i,name:S[2],strings:_,ctor:S[1]==="."?Le:S[1]==="?"?Ie:S[1]==="@"?je:gt}),n.removeAttribute(u)}else u.startsWith(z)&&(c.push({type:6,index:i}),n.removeAttribute(u));if(de.test(n.tagName)){const u=n.textContent.split(z),f=u.length-1;if(f>0){n.textContent=mt?mt.emptyScript:"";for(let _=0;_<f;_++)n.append(u[_],et()),W.nextNode(),c.push({type:2,index:++i});n.append(u[f],et())}}}else if(n.nodeType===8)if(n.data===ce)c.push({type:2,index:i});else{let u=-1;for(;(u=n.data.indexOf(z,u+1))!==-1;)c.push({type:7,index:i}),u+=z.length-1}i++}}static createElement(t,s){const a=H.createElement("template");return a.innerHTML=t,a}}function Y(e,t,s=e,a){if(t===G)return t;let n=a!==void 0?s._$Co?.[a]:s._$Cl;const i=st(t)?void 0:t._$litDirective$;return n?.constructor!==i&&(n?._$AO?.(!1),i===void 0?n=void 0:(n=new i(e),n._$AT(e,s,a)),a!==void 0?(s._$Co??=[])[a]=n:s._$Cl=n),n!==void 0&&(t=Y(e,n._$AS(e,t.values),n,a)),t}class ze{constructor(t,s){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=s}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:s},parts:a}=this._$AD,n=(t?.creationScope??H).importNode(s,!0);W.currentNode=n;let i=W.nextNode(),r=0,l=0,c=a[0];for(;c!==void 0;){if(r===c.index){let d;c.type===2?d=new rt(i,i.nextSibling,this,t):c.type===1?d=new c.ctor(i,c.name,c.strings,this,t):c.type===6&&(d=new Ue(i,this,t)),this._$AV.push(d),c=a[++l]}r!==c?.index&&(i=W.nextNode(),r++)}return W.currentNode=H,n}p(t){let s=0;for(const a of this._$AV)a!==void 0&&(a.strings!==void 0?(a._$AI(t,a,s),s+=a.strings.length-2):a._$AI(t[s])),s++}}class rt{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,s,a,n){this.type=2,this._$AH=p,this._$AN=void 0,this._$AA=t,this._$AB=s,this._$AM=a,this.options=n,this._$Cv=n?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode;const s=this._$AM;return s!==void 0&&t?.nodeType===11&&(t=s.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,s=this){t=Y(this,t,s),st(t)?t===p||t==null||t===""?(this._$AH!==p&&this._$AR(),this._$AH=p):t!==this._$AH&&t!==G&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):De(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==p&&st(this._$AH)?this._$AA.nextSibling.data=t:this.T(H.createTextNode(t)),this._$AH=t}$(t){const{values:s,_$litType$:a}=t,n=typeof a=="number"?this._$AC(t):(a.el===void 0&&(a.el=at.createElement(he(a.h,a.h[0]),this.options)),a);if(this._$AH?._$AD===n)this._$AH.p(s);else{const i=new ze(n,this),r=i.u(this.options);i.p(s),this.T(r),this._$AH=i}}_$AC(t){let s=Xt.get(t.strings);return s===void 0&&Xt.set(t.strings,s=new at(t)),s}k(t){Dt(this._$AH)||(this._$AH=[],this._$AR());const s=this._$AH;let a,n=0;for(const i of t)n===s.length?s.push(a=new rt(this.O(et()),this.O(et()),this,this.options)):a=s[n],a._$AI(i),n++;n<s.length&&(this._$AR(a&&a._$AB.nextSibling,n),s.length=n)}_$AR(t=this._$AA.nextSibling,s){for(this._$AP?.(!1,!0,s);t!==this._$AB;){const a=Bt(t).nextSibling;Bt(t).remove(),t=a}}setConnected(t){this._$AM===void 0&&(this._$Cv=t,this._$AP?.(t))}}class gt{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,s,a,n,i){this.type=1,this._$AH=p,this._$AN=void 0,this.element=t,this.name=s,this._$AM=n,this.options=i,a.length>2||a[0]!==""||a[1]!==""?(this._$AH=Array(a.length-1).fill(new String),this.strings=a):this._$AH=p}_$AI(t,s=this,a,n){const i=this.strings;let r=!1;if(i===void 0)t=Y(this,t,s,0),r=!st(t)||t!==this._$AH&&t!==G,r&&(this._$AH=t);else{const l=t;let c,d;for(t=i[0],c=0;c<i.length-1;c++)d=Y(this,l[a+c],s,c),d===G&&(d=this._$AH[c]),r||=!st(d)||d!==this._$AH[c],d===p?t=p:t!==p&&(t+=(d??"")+i[c+1]),this._$AH[c]=d}r&&!n&&this.j(t)}j(t){t===p?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class Le extends gt{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===p?void 0:t}}class Ie extends gt{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==p)}}class je extends gt{constructor(t,s,a,n,i){super(t,s,a,n,i),this.type=5}_$AI(t,s=this){if((t=Y(this,t,s,0)??p)===G)return;const a=this._$AH,n=t===p&&a!==p||t.capture!==a.capture||t.once!==a.once||t.passive!==a.passive,i=t!==p&&(a===p||n);n&&this.element.removeEventListener(this.name,this,a),i&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}}class Ue{constructor(t,s,a){this.element=t,this.type=6,this._$AN=void 0,this._$AM=s,this.options=a}get _$AU(){return this._$AM._$AU}_$AI(t){Y(this,t)}}const We=Nt.litHtmlPolyfillSupport;We?.(at,rt),(Nt.litHtmlVersions??=[]).push("3.3.3");const Fe=(e,t,s)=>{const a=s?.renderBefore??t;let n=a._$litPart$;if(n===void 0){const i=s?.renderBefore??null;a._$litPart$=n=new rt(t.insertBefore(et(),i),i,void 0,s??{})}return n._$AI(e),n};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`,qe="marstek_modbus";function Ge(e){const t=new Map;for(const s of Object.values(e.entities)){if(s.platform!==qe||!s.device_id||!s.translation_key)continue;let a=t.get(s.device_id);if(!a){const n=e.devices[s.device_id];a={deviceId:s.device_id,name:n?.name_by_user||n?.name||"Marstek Venus",byKey:{}},t.set(s.device_id,a)}a.byKey[s.translation_key]=s.entity_id}return[...t.values()].sort((s,a)=>s.name.localeCompare(a.name))}class Ye{constructor(t,s){this.hass=t,this.device=s}get name(){return this.device.name}entityId(t){return this.device.byKey[t]}has(t){return this.state(t)!==null}state(t){const s=this.device.byKey[t];if(!s)return null;const a=this.hass.states[s];return!a||a.state==="unavailable"||a.state==="unknown"?null:a}num(t){const s=this.state(t);if(!s)return null;const a=Number(s.state);return Number.isFinite(a)?a:null}str(t){return this.state(t)?.state??null}unit(t){return this.state(t)?.attributes.unit_of_measurement??""}rawState(t){const s=this.device.byKey[t];return s&&this.hass.states[s]||null}attr(t,s,a){return this.rawState(t)?.attributes[s]??a}writable(t){const s=this.rawState(t);return!!s&&s.state!=="unavailable"}label(t){const s=this.hass.states[this.device.byKey[t]??""]?.attributes.friendly_name;if(!s)return t;const a=this.device.name;return a&&s.startsWith(a)&&s.length>a.length+1?s.slice(a.length).trim():s}sum(t){let s=0,a=!1;for(const n of t){const i=this.num(n);i!==null&&(s+=i,a=!0)}return a?s:null}firstKey(t){return t.find(s=>this.entityId(s))??null}inverterState(){const s=this.num("battery_power"),a=this.num("ac_power"),n=s!==null&&s>30,i=a!==null&&a>30;return n&&i?"Bypass":this.str("inverter_state")}packCount(){let t=0;for(;this.device.byKey[`battery_${t+1}_max_cell_voltage`];)t++;let s=0;for(let a=1;a<=t;a++){const n=this.num(`battery_${a}_max_cell_voltage`);n!==null&&n>0&&(s=a)}return s||t}}class Je{constructor(t,s){this.hass=t,this.reader=s}call(t,s,a,n){const i=this.reader.entityId(a);i&&this.hass.callService(t,s,{entity_id:i,...n})}setNumber(t,s){this.call("number","set_value",t,{value:s})}selectOption(t,s){this.call("select","select_option",t,{option:s})}setSwitch(t,s){this.call("switch",s?"turn_on":"turn_off",t,{})}press(t){this.call("button","press",t,{})}}const Ze="modulepreload",Xe=function(e){return"/"+e},Qt={},Qe=function(t,s,a){let n=Promise.resolve();if(s&&s.length>0){let r=function(d){return Promise.all(d.map(m=>Promise.resolve(m).then(u=>({status:"fulfilled",value:u}),u=>({status:"rejected",reason:u}))))};document.getElementsByTagName("link");const l=document.querySelector("meta[property=csp-nonce]"),c=l?.nonce||l?.getAttribute("nonce");n=r(s.map(d=>{if(d=Xe(d),d in Qt)return;Qt[d]=!0;const m=d.endsWith(".css"),u=m?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${u}`))return;const f=document.createElement("link");if(f.rel=m?"stylesheet":Ze,m||(f.as="script"),f.crossOrigin="",f.href=d,c&&f.setAttribute("nonce",c),document.head.appendChild(f),m)return new Promise((_,S)=>{f.addEventListener("load",_),f.addEventListener("error",()=>S(new Error(`Unable to preload CSS for ${d}`)))})}))}function i(r){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=r,window.dispatchEvent(l),!l.defaultPrevented)throw r}return n.then(r=>{for(const l of r||[])l.status==="rejected"&&i(l.reason);return t().catch(i)})},nt={"tab.core":"OVERVIEW","tab.cells":"CELLS","tab.packs":"PACKS","tab.solar":"SOLAR","tab.energy":"ENERGY","tab.system":"SYSTEM","tab.control":"CONTROL","control.power":"Power now","control.power_hint":"These two set the working point directly. Anything that regulates the battery from outside — a zero-feed-in automation, an energy manager — writes the same registers and will win within seconds.","control.limits":"Limits","control.mode":"Mode","control.backup_hint":"Keeps a reserve for the off-grid output.","control.rs485_hint":"Switching this off hands control back to the device, and this page stops having any effect.","control.overwritten":"Something else changed {names} right after this panel did. An external controller is writing the same registers.","control.schedules":"Schedules","control.schedules_axis":"times are the device's own, in its local time","control.schedules_hint":"A schedule needs a window, a power and a day before switching it on does anything. Power is signed: the sign decides the direction. The device takes one day per schedule, not a set of them.","control.no_schedules":"This battery exposes no schedules.","control.window":"Window","control.sched_power":"Power","control.days":"Day","control.active":"On","control.unset":"not set","control.device":"Device","control.reset":"Restart device","control.reset_confirm":"Really restart","control.cancel":"Cancel","control.reset_hint":"Reconnects after a few seconds. A factory reset is deliberately not offered here — it is in the entity list.","control.opt.manual":"Manual","control.opt.anti_feed":"Anti-feed","control.opt.trade_mode":"Trade","control.opt.standby":"Standby","control.opt.charge":"Charge","control.opt.discharge":"Discharge","control.day.monday":"Mon","control.day.tuesday":"Tue","control.day.wednesday":"Wed","control.day.thursday":"Thu","control.day.friday":"Fri","control.day.saturday":"Sat","control.day.sunday":"Sun","status.modbus":"MODBUS","status.wifi":"WIFI","common.pack":"PACK","common.device":"Device","core.electrical":"Electrical · now","core.reserve":"Reserve · lifetime","core.stored":"Stored","core.capacity":"Capacity","core.stored_of_total":"Stored / total","core.usable":"Usable","core.to_full":"Room to full","core.runtime":"Runtime","core.to_empty":"Until empty","core.until_full":"Until full","core.packs":"Packs","core.soc_bms":"SOC · BMS","core.soc_usable":"usable {value} %","core.discharging_to_house":"discharging","core.charging_from_grid":"charging","core.at_rest":"at rest","core.today_charged":"Charged today","core.today_discharged":"Discharged today","core.cell_delta":"Largest cell delta","core.internal_temp":"Internal temperature","core.mppt_total":"MPPT total","core.in_pack":"in pack {pack}","core.no_delta":"no per-pack readings","cells.highest":"Highest cell","cells.lowest":"Lowest cell","cells.in_pack":"pack {pack}","cells.stack_spread":"Spread across stack","cells.stack_hint":"packs charge in turn, so a spread is expected","cells.mean_delta":"Mean delta in pack","cells.worst_pack":"widest: pack {pack}, {value} mV","cells.temp_span":"Cell temperature span","cells.packs_online":"Packs reporting","cells.cells_total":"{count} cells","cells.matrix_title":"Cell voltage range per pack · shared axis","cells.matrix_axis":"bar = lowest to highest cell","cells.matrix_legend":"The tick inside each bar is the pack's midpoint. A narrow bar is a balanced pack, a wide one is drift inside it, and a bar sitting apart from the others is a pack at a different level than the rest.","cells.no_ranges":"This battery reports no per-pack cell voltages.","cells.protection":"Protection and faults","cells.protection_all":"Protection · all {count} packs","cells.clear":"clear","cells.conducting":"Pack conducting","cells.conducting_none":"none — every pack disconnected","cells.conducting_hint":"The device works one pack at a time and closes that pack's MOSFETs while it does. A pack listed here is doing the work, not reporting a fault.","cells.mos_unexpected":"unexpected MOSFET status","cells.raised":"raised","cells.bms":"BMS","cells.bms_version":"BMS version","cells.uniform":"same on every pack","packs.device_reading":"as the device reports it","packs.mean_soc":"Mean of the packs","packs.from_n_packs":"from {count} packs","packs.spread":"Spread","packs.stored_total":"Stored energy","packs.summed":"packs add up to {value} kWh","packs.per_pack":"Per pack","packs.nominal":"nominal, capacity ÷ packs","packs.cycles_mean":"Cycles, mean per pack","packs.cycles_partial":"{have} of {total} packs report","packs.fill_title":"State of charge per pack","packs.fill_axis":"column height = SOC · figure inside = kWh","packs.fill_legend":"The dashed line marks the discharge floor at {floor} %. Energy per pack is worked out from its SOC and the nominal pack size; the battery reports no energy figure of its own per pack.","packs.fill_legend_backup":"The dotted line at {backup} % is as far as the backup socket discharges during an outage.","packs.fill_legend_nofloor":"Energy per pack is worked out from its SOC and the nominal pack size; the battery reports no energy figure of its own per pack.","packs.none":"This battery reports no per-pack state of charge.","packs.table_title":"Every pack in detail","packs.table_legend":"Highlighted rows sit {points} points or further from the median pack. A pack that reports a high SOC at a low cell voltage is worth a second look: the two readings disagree.","packs.conducting":"conducting now","packs.col_soc":"SOC","packs.col_energy":"kWh","packs.col_min":"Cell min","packs.col_max":"Cell max","packs.col_delta":"Delta","packs.col_voltage":"Voltage","packs.col_current":"Current","packs.col_cycles":"Cycles","packs.col_mos":"MOSFET","packs.col_env":"Ambient","packs.col_ntc":"NTC 1–4","solar.active":"ACTIVE","solar.floating":"FLOATING","solar.summary":"All inputs","solar.some_active":"carrying power","solar.all_idle":"nothing connected","solar.note_active":"Voltage follows the panels and power follows the sun through the day.","solar.note_floating":"All inputs sit at a low voltage without current, which is what an unused MPPT input looks like. Connect panels and the voltage rises to module level.","solar.diagnostics":"Diagnostics","solar.channels_reporting":"Inputs reporting","solar.none":"This battery has no MPPT inputs.","energy.today":"Today","energy.month":"This month","energy.lifetime":"Since commissioning","energy.charged":"charged kWh","energy.discharged":"discharged kWh","energy.loss":"Loss","energy.returned":"Returned","energy.rte":"Round trip","energy.rte_hint":"Round-trip efficiency is how much of the energy put into the battery comes back out of it. Conversion efficiency is the loss in the moment, at the current operating point.","energy.efficiency":"Efficiency compared","energy.throughput":"Throughput and wear","energy.gap_hint":"The monthly figure sits {value} points below the lifetime one. That gap is not conversion loss but standby draw between cycles: the shallower the cycling, the heavier it weighs.","system.no_faults":"No fault register is raised.","system.faults_raised":"Raised: {list}","system.device":"Device","system.packs":"Battery packs","system.firmware":"Firmware","system.connection":"Connection","system.faults":"Fault registers","system.control":"Control and limits","system.thermal":"Thermal and electrical","system.ceiling_used":"The panel treats {value} % as the charge ceiling, read from this register.","system.ceiling_ignored":"This register reads {value} %, outside its own 10-100 range, so the device is not using it. The panel charges towards 100 % instead.","settings.title":"Settings","settings.scheme":"Colour scheme","settings.scheme_hint":"Each scheme brings its own light and dark version. The swatch is painted in the scheme it offers.","settings.scheme_theme":"follows your theme","settings.appearance":"Appearance","settings.mode":"Light or dark","settings.mode.auto":"Home Assistant","settings.mode.dark":"Dark","settings.mode.light":"Light","settings.mode_ha":"This scheme takes its colours from your Home Assistant theme, which already decides light or dark.","settings.digits":"Decimal places","settings.digits.normal":"Normal","settings.digits.more":"One more","settings.start_tab":"Tab when opening","settings.start_tab.last":"Last used","settings.start_tab_hint":"A fixed tab that the battery cannot fill falls back to the overview.","settings.tabs":"Tabs","settings.tabs_hint":"Greyed out means this battery does not report what the tab shows, so hiding it is not a choice you have to make.","settings.always":"always shown","settings.unavail.cells":"no per-cell voltages","settings.unavail.packs":"no state of charge per pack","settings.unavail.solar":"no PV inputs","settings.unavail.control":"no writable registers","settings.scale":"Scale","settings.width":"Content width","settings.width.full":"Full width","settings.screen_hint":"Scale and width belong to this browser: a phone and a 4K monitor want different answers, so they are not carried across devices or included in the export.","settings.storage":"Stored settings","settings.reset":"Reset to defaults","settings.transfer":"Import / export","settings.transfer_hint":"Copy this out, paste it in somewhere else. Scale and width are not part of it.","settings.transfer_bad":"That is not a settings object.","settings.import":"Apply pasted","settings.export_again":"Show current","settings.storage_hint":"Everything except scale and width is stored in Home Assistant under your user, so the same panel follows you to every device. Other people keep their own.","settings.offline":"Home Assistant did not answer, so nothing changed here will be kept. Reload the panel to try again.","empty.no_device":"No Marstek battery found","empty.no_device_hint":"This panel reads the Marstek Modbus Suite integration. Add a battery there first.","common.unavailable":"—"},me={de:()=>Qe(()=>import("./marstek-modbus-lang-de.js"),[]).then(e=>e.de)};["en",...Object.keys(me)].sort();const lt={en:nt};function ts(e){return e.split("-")[0].toLowerCase()}async function es(e){const t=ts(e);if(lt[t])return lt[t];const s=me[t];if(!s)return nt;try{return lt[t]=await s(),lt[t]}catch{return nt}}function ss(e,t,s){let a=e[t]??nt[t]??t;if(s)for(const[n,i]of Object.entries(s))a=a.replace(`{${n}}`,String(i));return a}const ct="—";class te{constructor(t,s=0){this.language=t,this.extra=s,this.cache=new Map}get extraDigits(){return this.extra}formatter(t){const s=String(t);let a=this.cache.get(s);return a||(a=new Intl.NumberFormat(this.language||"en",{minimumFractionDigits:t,maximumFractionDigits:t}),this.cache.set(s,a)),a}num(t,s=0){return t==null||!Number.isFinite(t)?ct:this.formatter(s+this.extra).format(t)}signed(t,s=0){if(t==null||!Number.isFinite(t))return ct;const a=this.formatter(s+this.extra).format(Math.abs(t));return t>0?`+${a}`:t<0?`−${a}`:a}version(t){return t==null||t===""?ct:/^\d{4}$/.test(t)?`${t.slice(0,3)}.${t.slice(3)}`:t}millivolts(t){return t==null||!Number.isFinite(t)?ct:this.formatter(0).format(Math.round(t*1e3))}}var as=Object.defineProperty,zt=(e,t,s,a)=>{for(var n=void 0,i=e.length-1,r;i>=0;i--)(r=e[i])&&(n=r(t,s,n)||n);return n&&as(t,s,n),n};const Ut=class Ut extends ${kv(t,s=1,a={}){const n=this.reader;if(!n.entityId(t))return p;const i=n.state(t);if(!i)return p;if(a.version)return o`
    ...
    `}kvFirst(t,s=1,a={}){const n=t.find(i=>this.reader.entityId(i));return n?this.kv(n,s,a):p}row(t,s,a=""){return o`
      <div class="kv">
        <span>${t}</span>
        <b class=${a}>${s}</b>
      </div>
    `}get packs(){return Array.from({length:this.reader.packCount()},(t,s)=>s+1)}};Ut.styles=[v];let A=Ut;zt([h({attribute:!1})],A.prototype,"reader");zt([h({attribute:!1})],A.prototype,"fmt");zt([h({attribute:!1})],A.prototype,"t");var ns=Object.defineProperty,is=Object.getOwnPropertyDescriptor,ot=(e,t,s,a)=>{for(var n=a>1?void 0:a?is(t,s):t,i=e.length-1,r;i>=0;i--)(r=e[i])&&(n=(a?r(t,s,n):r(n))||n);return a&&n&&ns(t,s,n),n};const yt=118,_t=97,rs=2*Math.PI*yt,os=2*Math.PI*_t;let V=class extends ${constructor(){super(...arguments),this.soc=null,this.usable=null,this.caption="",this.sub=""}arc(e,t){const s=e===null?0:Math.min(Math.max(e,0),100);return`${t*s/100} ${t}`}render(){const e=this.soc===null?"—":Math.round(this.soc).toString();return o`
      <svg
        viewBox="0 0 300 268"
        role="img"
    ...
    `];ot([h({type:Number})],V.prototype,"soc",2);ot([h({type:Number})],V.prototype,"usable",2);ot([h({type:String})],V.prototype,"caption",2);ot([h({type:String})],V.prototype,"sub",2);V=ot([b("mk-gauge")],V);var ls=Object.defineProperty,cs=Object.getOwnPropertyDescriptor,L=(e,t,s,a)=>{for(var n=a>1?void 0:a?cs(t,s):t,i=e.length-1,r;i>=0;i--)(r=e[i])&&(n=(a?r(t,s,n):r(n))||n);return a&&n&&ls(t,s,n),n};let E=class extends ${constructor(){super(...arguments),this.label="",this.value="—",this.unit="",this.foot="",this.tone="",this.bar=null,this.max=null}get fill(){return this.bar===null||this.max===null||this.max===0?null:Math.min(Math.max(this.bar/this.max*100,0),100)}render(){const e=this.fill;return o`
    ...
    `];L([h({type:String})],E.prototype,"label",2);L([h({type:String})],E.prototype,"value",2);L([h({type:String})],E.prototype,"unit",2);L([h({type:String})],E.prototype,"foot",2);L([h({type:String})],E.prototype,"tone",2);L([h({type:Number})],E.prototype,"bar",2);L([h({type:Number})],E.prototype,"max",2);E=L([b("mk-stat")],E);const ds=.05,ue=.1;function fe(e){return e===null?"":e>=ue?"crit":e>=ds?"warn":"ok"}function ge(e){const t=fe(e);return t==="ok"?"":t}var ps=Object.getOwnPropertyDescriptor,hs=(e,t,s,a)=>{for(var n=a>1?void 0:a?ps(t,s):t,i=e.length-1,r;i>=0;i--)(r=e[i])&&(n=r(n)||n);return n};const ms=30;let xt=class extends A{render(){const e=this.reader,t=this.fmt,s=this.t,a=e.num("battery_soc"),n=e.num("battery_total_energy"),i=e.num("stored_energy"),r=e.num("battery_power"),l=e.num("usable_energy"),c=l!==null&&n?l/n*100:null,d=r!==null&&Math.abs(r)>ms,m=d&&r<0,u=e.packCount();return o`
      <div class="top">
        <div class="panel">
    ...
    `}deltaTile(){const e=this.reader;let t=null;for(let a=1;a<=e.packCount();a++){const n=e.num(`battery_${a}_max_cell_voltage`),i=e.num(`battery_${a}_min_cell_voltage`);if(n===null||i===null)continue;const r=n-i;(!t||r>t.delta)&&(t={pack:a,delta:r})}const s=fe(t?.delta??null);return o`
      <mk-stat
    ...
    `];xt=hs([b("mk-view-core")],xt);var us=Object.defineProperty,fs=Object.getOwnPropertyDescriptor,vt=(e,t,s,a)=>{for(var n=a>1?void 0:a?fs(t,s):t,i=e.length-1,r;i>=0;i--)(r=e[i])&&(n=(a?r(t,s,n):r(n))||n);return a&&n&&us(t,s,n),n};let J=class extends ${constructor(){super(...arguments),this.ranges=[],this.packLabel="PACK",this.formatVolts=e=>e.toFixed(3)}get bounds(){const e=this.ranges.flatMap(n=>[n.min,n.max]);if(!e.length)return{lo:3.2,hi:3.4};const t=Math.min(...e),s=Math.max(...e),a=Math.max((s-t)*.15,.005);return{lo:t-a,hi:s+a}}pct(e){const{lo:t,hi:s}=this.bounds,a=s-t||1;return(e-t)/a*100}render(){if(!this.ranges.length)return p;const{lo:e,hi:t}=this.bounds,s=[0,.25,.5,.75].map(a=>({at:a*100,value:e+(t-e)*a}));return o`
      <div class="axis">
        <div></div>
        <div class="ticks">
      ...
      ${this.ranges.map(a=>{const n=a.max-a.min,i=ge(n),r=this.pct(a.min),l=Math.max(this.pct(a.max)-r,.6),c=this.pct((a.min+a.max)/2);return o`
          <div class="row">
    ...
    `];vt([h({attribute:!1})],J.prototype,"ranges",2);vt([h({type:String})],J.prototype,"packLabel",2);vt([h({attribute:!1})],J.prototype,"formatVolts",2);J=vt([b("mk-pack-matrix")],J);var gs=Object.getOwnPropertyDescriptor,vs=(e,t,s,a)=>{for(var n=a>1?void 0:a?gs(t,s):t,i=e.length-1,r;i>=0;i--)(r=e[i])&&(n=r(n)||n);return n};const bs=3,ks=[0,2,3];let wt=class extends A{get ranges(){const e=this.reader,t=[];for(const s of this.packs){const a=e.num(`battery_${s}_min_cell_voltage`),n=e.num(`battery_${s}_max_cell_voltage`);if(a===null||n===null)continue;const i=e.num(`battery_${s}_cycle_count`),r=e.num(`battery_${s}_mos_temperature`),l=[i===null?null:`${this.fmt.num(i,0)} ⟳`,r===null?null:`${this.fmt.num(r,1)} °C`].filter(Boolean).join(" · ");t.push({index:s,min:a,max:n,note:l})}return t}render(){const e=this.reader,t=this.fmt,s=this.t,a=this.ranges,n=a.map(m=>m.max),i=a.map(m=>m.min),r=a.length?Math.max(...n)-Math.min(...i):null,l=a.reduce((m,u)=>!m||u.max-u.min>m.max-m.min?u:m,null),c=a.map(m=>m.max-m.min),d=c.length?c.reduce((m,u)=>m+u,0)/c.length:null;return o`
      <div class="grid tiles">
        <mk-stat
    ...
    `];wt=vs([b("mk-view-cells")],wt);var $s=Object.defineProperty,ys=Object.getOwnPropertyDescriptor,I=(e,t,s,a)=>{for(var n=a>1?void 0:a?ys(t,s):t,i=e.length-1,r;i>=0;i--)(r=e[i])&&(n=(a?r(t,s,n):r(n))||n);return a&&n&&$s(t,s,n),n};let O=class extends ${constructor(){super(...arguments),this.packs=[],this.floor=null,this.backupFloor=null,this.packLabel="PACK",this.energyUnit="kWh",this.formatNumber=e=>e===null?"—":String(e),this.tolerance=5}fill(e){if(e===null)return"var(--mk-track)";const t=Math.min(Math.max(e,0),100)/100,s=t<.5?4+41*(t/.5):45+95*((t-.5)/.5);return`linear-gradient(180deg, hsl(${s.toFixed(0)} 74% 56%), hsl(${s.toFixed(0)} 68% 43%))`}render(){if(!this.packs.length)return p;const e=this.packs.map(s=>s.soc).filter(s=>s!==null).sort((s,a)=>s-a),t=e.length?e[Math.floor(e.length/2)]:null;return o`
      <div class="scroll">
      <div
        class="rack"
    ...
    `];ut=xs([b("mk-view-packs")],ut);var As=Object.getOwnPropertyDescriptor,Cs=(e,t,s,a)=>{for(var n=a>1?void 0:a?As(t,s):t,i=e.length-1,r;i>=0;i--)(r=e[i])&&(n=r(n)||n);return n};const Q=[1,2,3,4],se=1;let St=class extends A{render(){const e=this.reader,t=this.fmt,s=this.t,a=Q.map(l=>e.num(`mppt${l}_power`)),n=e.sum(Q.map(l=>`mppt${l}_power`)),i=Math.max(...a.map(l=>l??0),1),r=a.some(l=>l!==null&&l>se);return Q.some(l=>e.entityId(`mppt${l}_power`))?o`
    ...
    `}period(e){const t=this.reader,s=this.fmt,a=this.t,n=t.firstKey(e.charge),i=t.firstKey(e.discharge),r=n?t.num(n):null,l=i?t.num(i):null;if(r===null&&l===null)return p;const c=r?(l??0)/r*100:null,d=r!==null&&l!==null?r-l:null,m=e.efficiency?t.num(e.efficiency):null;return o`
      <div class="panel">
        <div class="head">
    ...
    `];At=Ts([b("mk-view-energy")],At);var Os=Object.getOwnPropertyDescriptor,Ms=(e,t,s,a)=>{for(var n=a>1?void 0:a?Os(t,s):t,i=e.length-1,r;i>=0;i--)(r=e[i])&&(n=r(n)||n);return n};const ae=["alarm_status","fault_status","fault_status_low","fault_status_2","fault_status_2_low","mppt_error","mppt_warning"];let Ct=class extends A{render(){const e=this.reader,t=this.t,s=ae.filter(a=>{const n=e.num(a);return n!==null&&n!==0});return o`
    ...
    `];B([h({type:String})],D.prototype,"label",2);B([h({attribute:!1})],D.prototype,"options",2);B([h({type:String})],D.prototype,"value",2);B([h({type:Boolean})],D.prototype,"disabled",2);B([h({attribute:!1})],D.prototype,"onSelect",2);B([k()],D.prototype,"pending",2);D=B([b("mk-segment")],D);var Ls=Object.defineProperty,Is=Object.getOwnPropertyDescriptor,j=(e,t,s,a)=>{for(var n=a>1?void 0:a?Is(t,s):t,i=e.length-1,r;i>=0;i--)(r=e[i])&&(n=(a?r(t,s,n):r(n))||n);return a&&n&&Ls(t,s,n),n};let M=class extends ${constructor(){super(...arguments),this.label="",this.hint="",this.bare=!1,this.checked=null,this.disabled=!1,this.pending=null}willUpdate(e){e.has("checked")&&this.pending!==null&&this.checked===this.pending&&(this.pending=null)}render(){const e=this.pending??this.checked;return o`
      ${this.bare?p:o`
            <div class="text">
    ...
    `];R([h({attribute:!1})],T.prototype,"rows",2);R([h({attribute:!1})],T.prototype,"labels",2);R([h({attribute:!1})],T.prototype,"dayLabel",2);R([h({attribute:!1})],T.prototype,"formatNumber",2);R([h({attribute:!1})],T.prototype,"onEnable",2);R([h({attribute:!1})],T.prototype,"onTime",2);R([h({attribute:!1})],T.prototype,"onPower",2);R([h({attribute:!1})],T.prototype,"onDays",2);T=R([b("mk-schedule")],T);var Ws=Object.defineProperty,Fs=Object.getOwnPropertyDescriptor,bt=(e,t,s,a)=>{for(var n=a>1?void 0:a?Fs(t,s):t,i=e.length-1,r;i>=0;i--)(r=e[i])&&(n=(a?r(t,s,n):r(n))||n);return a&&n&&Ws(t,s,n),n};const ne=["set_charge_power","set_discharge_power"],ie=["max_charge_power","max_discharge_power"],Hs=[1,2,3,4,5,6],Vs=30;let Z=class extends A{constructor(){super(...arguments),this.wrote={},this.confirmReset=!1}note(e){this.wrote={...this.wrote,[e]:Date.now()}}overwritten(e){const t=this.wrote[e];if(!t)return!1;const s=this.reader.rawState(e)?.last_updated;if(!s)return!1;const a=(new Date(s).getTime()-t)/1e3;return a>.5&&a<Vs}slider(e){const t=this.reader;return t.entityId(e)?o`
      <mk-slider
        label=${t.label(e)}
        .value=${t.num(e)}
        .min=${t.attr(e,"min",0)}
    ...
    `];w([h({attribute:!1})],y.prototype,"settings",2);w([h({attribute:!1})],y.prototype,"local",2);w([h({attribute:!1})],y.prototype,"tabs",2);w([h({attribute:!1})],y.prototype,"t",2);w([h({attribute:!1})],y.prototype,"onChange",2);w([h({attribute:!1})],y.prototype,"onChangeLocal",2);w([h({attribute:!1})],y.prototype,"onReset",2);w([h({type:Boolean})],y.prototype,"offline",2);w([h({type:Boolean})],y.prototype,"light",2);w([k()],y.prototype,"transferOpen",2);w([k()],y.prototype,"transferText",2);w([k()],y.prototype,"transferBad",2);y=w([b("mk-view-settings")],y);var ra=Object.defineProperty,oa=Object.getOwnPropertyDescriptor,N=(e,t,s,a)=>{for(var n=a>1?void 0:a?oa(t,s):t,i=e.length-1,r;i>=0;i--)(r=e[i])&&(n=(a?r(t,s,n):r(n))||n);return a&&n&&ra(t,s,n),n};const $t=["core","cells","packs","solar","energy","control","system"],la={cells:"battery_1_max_cell_voltage",packs:"battery_soc_1",solar:"mppt1_power",control:"set_charge_power"},ye="marstek-panel.device",_e="marstek-panel.tab";let C=class extends ${constructor(){super(...arguments),this.narrow=!1,this.settings={...F},this.local=Qs(),this.settingsOffline=!1,this.tab="core",this.showSettings=!1,this.strings=nt,this.deviceId=da(),this.catalogueFor="",this.appearanceFor="",this.layoutFor="",this.sharedRequested=!1,this.formatter=new te("en"),this.markTabEdges=()=>{const e=this.renderRoot.querySelector("nav");if(!e)return;e.dataset.bound||(e.dataset.bound="1",e.addEventListener("scroll",this.markTabEdges,{passive:!0}),new ResizeObserver(this.markTabEdges).observe(e));const t=e.scrollLeft>1,s=e.scrollLeft+e.clientWidth<e.scrollWidth-1;e.dataset.edge=t&&s?"both":t?"left":s?"right":"none"},this.t=(e,t)=>ss(this.strings,e,t)}connectedCallback(){super.connectedCallback(),this.tab=this.startingTab()}willUpdate(e){if(this.applyLayout(),!this.hass||(this.loadShared(),!e.has("hass")&&!e.has("settings")))return;this.applyAppearance();const t=this.hass.language||"en",s=this.settings.extraDigits?1:0;(t!==this.catalogueFor||this.formatter.extraDigits!==s)&&(this.formatter=new te(t,s)),t!==this.catalogueFor&&(this.catalogueFor=t,es(t).then(a=>{this.catalogueFor===t&&(this.strings=a)}))}applyAppearance(){const e=this.settings.mode,t=e==="auto"?!this.hass.themes?.darkMode:e==="light",s=`${this.settings.scheme}/${t}`;s!==this.appearanceFor&&(this.appearanceFor=s,this.toggleAttribute("light",t),Bs(this,this.settings.scheme,t))}applyLayout(){const{fontScale:e,maxWidth:t}=this.local,s=`${e}/${t}`;s!==this.layoutFor&&(this.layoutFor=s,this.style.setProperty("--mk-zoom",String(e/100)),this.style.setProperty("--mk-max-width",t==="full"?"100%":`${t}px`))}loadShared(){this.sharedRequested||(this.sharedRequested=!0,sa(this.hass).then(e=>{if(e===null){this.settingsOffline=!0;return}this.settings=e,this.tab=this.startingTab()}))}startingTab(){const e=this.settings.startTab==="last"?ca():this.settings.startTab;return $t.includes(e)?e:"core"}update_(e){this.settings={...this.settings,...e},Tt(this.hass,this.settings)}updateLocal(e){this.local={...this.local,...e},ta(this.local)}resetSettings(){this.settings={...F},Tt(this.hass,this.settings),ea(),this.local={...it}}openTab(e){this.tab=e,this.showSettings=!1;try{localStorage.setItem(_e,e)}catch{}}updated(){this.markTabEdges()}selectDevice(e){this.deviceId=e;try{localStorage.setItem(ye,e)}catch{}}tabsFor(e){return $t.filter(t=>this.supports(e,t)&&(t==="core"||!this.settings.hiddenTabs.includes(t)))}supports(e,t){const s=la[t];return!s||e.entityId(s)!==void 0}tabChoices(e){return $t.map(t=>({id:t,label:this.t(`tab.${t}`),available:this.supports(e,t)}))}get devices(){return this.hass?Ge(this.hass):[]}get device(){const e=this.devices;return e.length?e.find(t=>t.deviceId===this.deviceId)??e[0]:null}render(){if(!this.hass)return p;const e=this.device;if(!e)return o`
        <div class="shell">
          <div class="empty">
      ...
      <div class="shell">
        ...
        <main>
          ${this.showSettings?o`<mk-view-settings
                ...
                .onChangeLocal=${n=>this.updateLocal(n)}
    ...
    `}onTabKey(e,t,s){const a=e.key==="ArrowRight"?1:e.key==="ArrowLeft"?-1:0;if(!a)return;e.preventDefault();const n=s[(s.indexOf(t)+a+s.length)%s.length];this.tab=n,this.renderRoot.querySelectorAll("button.tab")[s.indexOf(n)]?.focus()}statusBar(e){const t=this.devices,s=this.device?.deviceId,a=e.num("wifi_signal_strength");return o`
      <div class="status">
        ...
        ${e.inverterState()?o`<span>${e.inverterState()}</span>`:p}
        <button
          class="gear"
